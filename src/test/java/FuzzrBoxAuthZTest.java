...
public class FuzzrBoxAuthZTest {

    private final String securityDomainName = "KerberosLogin";
    private final String configFile = "config/fuzzBoxAuthZ.conf";
    ...
    public void simpleAuth() throws AuthorizationException {
        ...
        Principal principal = TestUtil.getPrincipal(testVals.get("user").toString());
        Object credential = testVals.get("pass");
